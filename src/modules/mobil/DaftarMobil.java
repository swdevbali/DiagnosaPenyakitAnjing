 ...
 * @author  PRAM WEE
 */
public class DaftarMobil extends javax.swing.JPanel {

    private static DaftarMobil instance = null;
    private TableController tblDataController = null;

    public static DaftarMobil getInstance() {
        if (instance == null) {
            instance = new DaftarMobil();
        }
        return instance;
    }
    ...
    private DaftarMobil() {
        initComponents();
        String s = ApplicationLogic.getInstance().getQueryDaftarMobil();


        tblDataController = new TableController(this, "mobil", s, tblData, beanData,"idmobil",true);
