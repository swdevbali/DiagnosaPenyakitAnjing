...
public class DaftarRiwayatServis extends javax.swing.JPanel {
    ...
    private DaftarRiwayatServis() {
        try {
            ...
            initComponents();
            tblDataController = new TableController(this, "pelanggan", ApplicationLogic.getInstance().getQueryDaftarGejala(), tblSukuCadang, null, "idpelanggan", true);
            tblDataController.setState(TableController.STATE_BROWSE);
            tblData2Controller = new TableController(this, "pelanggan", ApplicationLogic.getInstance().getQueryDaftarGejala(), tblItemServis, null, "idpelanggan", true);
